  ...
  <div class="header">
    ...
    <div class="header-right">
      <div class="header-user-con">
        ...
        <!-- 用户头像 -->
        <div class="user-avator"><i class="el-icon-goods"></i></div>
          <!-- 用户名下拉菜单 -->
            <el-dropdown class="user-name" trigger="click" @command="handleCommand">
                <span class="el-dropdown-link">平<i class="el-icon-caret-bottom"></i>
                </span>
                <el-dropdown-menu slot="dropdown">
                    <a href="https://github.com/zhangjunpingping" target="_blank">
...
export default {
  ...
  methods: {
    ...
    handleCommand(command) {
      if (command === "loginout") {
        delCookie("accessTokenExamAdmin");
