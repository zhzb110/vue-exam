  	...
  	<div>
  		...
  		<div class="top-form">
		    ...
		    <div class="formBtns">
		        ...
		        <el-button type="primary" plain @click="checkQuestion('')">逐题审核</el-button>
              ...
              <template slot-scope="scope">
		        ...
		        <el-table-column label="操作" width="190">
		         <template  v-if="true" slot-scope="scope" >
		          <el-button type="primary" plain v-if="scope.row.approveStatus==1" @click="checkQuestionInformation(scope.row.id)" class="el-table-btn">浏览</el-button>
              <el-button type="primary" plain v-else @click="checkQuestion(scope.row.id)" class="el-table-btn">审核</el-button>
	              ...
	              <el-button class="el-table-btn" v-else type="danger" plain @click="stopQuestion(scope.row.id)" >停用</el-button>
			     </template>
			    </el-table-column>
			</el-table>
	     	<!--分页组件-->
...
export default {
  ...
  methods: {
    ...
    createQuestions() {
      this.$router.push({ path: "createQues?courseId="+this.courseId });
    },
     checkQuestionInformation(quesId) { // 查看试题做成弹出框形式
    ...
    // 审核试题
    checkQuestion(id) {
      this.$router.push({ path: "checkOne?testId="+id+"&courseId="+this.courseId });
    },
    edtiorQuestion(quesId) {
     this.$router.push({ path: "../maintainQues/editQues", query:{quesId:quesId,courseId:this.courseId} });
    },
