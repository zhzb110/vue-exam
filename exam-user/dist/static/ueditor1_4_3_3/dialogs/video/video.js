...
(function(){
    ...
    function insertUpload(){
        var videoObjs=[],
            ...
            width = $G('upload_width').value || 320,
            height = $G('upload_height').value || 240,
     ...
     * 获取媒体类型
     * @param {string} src
     * @returns {integer} 1: 图片 2：音频 3：视频
     */
    function getMediaType(src){
      var imageExt='.png, .jpg, .jpeg, .gif, .bmp'
      var audioExt='.mp3, .wav, .mid, .ogg'
      var videoExt='.flv, .mkv, .avi, .rm, .rmvb, .mpeg, .mpg, .ogv, .mov, .wmv, .mp4, .webm'
